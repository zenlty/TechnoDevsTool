...
namespace TechnoDevs_Tool
{
    public partial class demo : Form
    {
        ...
        private void demo_Load(object sender, EventArgs e)
        {
            ...
            /*finish*/
            anahtar = anahtar.CreateSubKey("Software\\Google\\Chrome\\PreferenceMACs\\Default\\Source"); //REGİSTERED
            ...
            if ((anahtar.GetValue("Aktif") != null))
            {
                ...
                txtserial.Text = "Release Day : 14.09.2018 //V2.2.1";
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (sonuc <= 0)
                    {
                        ...
                        System.Diagnostics.Process.Start("https://gsmturkey.net/threads/gsm-turkey-tool-v2-2-1.1669/");
            ...
            if (txtserial.Text == "Release Day : 01.09.2018 //17")
            {
                label3.Text = ("</ARISH>");
        ...
        private void button4_Click_1(object sender, EventArgs e)
        {

            {
                ...
                if (txtserial.Text == "forumandroid.com") //premium5
                {
                    MessageBox.Show("HOŞGELDİNİZ.", "FORUMANDROID KULLANICILARI");
                    anahtar.SetValue("Aktif", 3, RegistryValueKind.String);
                    anahtar.Flush();
                    Application.Restart();
                ...
                if (txtserial.Text == "ergregrtergghenrlgergergıvhfvıjsflbhefsgvşlm") //kullanıldı 100TL //https://www.facebook.com/mesutkaan.yoruk
                {
                    MessageBox.Show("HOŞGELDİNİZ.", "PREMIUM");
                    anahtar.SetValue("Aktif", 3, RegistryValueKind.String);
                    anahtar.Flush();
                ...
                else
                {
                    ...
                    System.Diagnostics.Process.Start("https://www.forumandroid.com/konu/forumandroid-tool.13134/");
                }
            }
        }
        ...
        {
            MessageBox.Show("Artık Ücretsiz","Bilgilendirme");
            System.Diagnostics.Process.Start("https://www.forumandroid.com/konu/forumandroid-tool.13134/");
        ...
        {
            System.Diagnostics.Process.Start("https://gsmturkey.net/members/baris-mizrakli.17/");
        }

        private void txtserial_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
